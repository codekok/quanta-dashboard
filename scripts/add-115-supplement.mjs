...
const additions = [
  ...
  { city: "宜蘭縣", district: "羅東鎮", originalName: "成功國小", school: "縣立成功國小", division: "國小", status: "現存", coverage: "國小", identity: "正式學校", type: "國小" },
  { city: "宜蘭縣", district: "員山鄉", originalName: "同樂國小", school: "縣立同樂國小", division: "國小", status: "現存", coverage: "國小", identity: "正式學校", type: "國小" },
  { city: "宜蘭縣", district: "宜蘭市", originalName: "南屏國小", school: "縣立南屏國小", division: "國小", status: "現存", coverage: "國小", identity: "正式學校", type: "國小" },
  { city: "宜蘭縣", district: "蘇澳鎮", originalName: "文化國中", school: "縣立文化國中", division: "國中", status: "現存", coverage: "國中", identity: "正式學校", type: "國中" },
];
...
const retained = rows.filter((row) => {
  ...
  const replace = additions.some((item) => row.year === year && row.city === item.city && row.school === item.school && row.program === program);
