...
## 2026-09-11｜更正芙朝國小行政區

- 彰化縣「縣立芙朝國小」行政區由芳苑鄉更正為埤頭鄉。
- 方案維持 115 學年度縣市合作；全部資料 1,041 筆、115 學年度 138 筆。
- 重複資料鍵為 0；資料稽核與 Lint 通過。

## 2026-09-11｜新增彰化縣芙朝國小

- 115 學年度縣市合作新增彰化縣「縣立芙朝國小」（行政區：芳苑鄉）。
- 全部資料調整為 1,041 筆；115 學年度調整為 138 筆，其中縣市合作 69 筆、策略聯盟 5 筆、全國甄選 64 筆。
- 重複資料鍵為 0；資料稽核與 Lint 通過。

## 2026-09-11｜更新 115 學年度方案名單

- 全國甄選移除臺南市立九份子國民中小學，新增苗栗縣苗栗市建功國民小學。
- 策略聯盟新增宜蘭縣「縣立礁溪國小」（行政區：礁溪鄉）。
- 115 學年度資料調整為 137 筆：全國甄選 64 筆、策略聯盟 5 筆、縣市合作 68 筆。
- 全部資料 1,040 筆，重複資料鍵為 0；資料稽核與 Lint 通過。

## 2026-08-20｜新增廣達游智盃歷屆參與隊伍數

- 游智盃指標新增「歷屆參與隊伍數」；第一至第七屆分別為 355、835、858、905、1,519、1,586、1,056 隊，合計 7,114 隊。
- 歷屆參與趨勢卡片同步呈現每屆參與學校數與參與隊伍數。
- 游智盃原有 623 所學校、1,208 校次及 24 個參與地區統計維持不變。
- 完成資料稽核、Lint、TypeScript 與 GitHub Pages 建置。

## 2026-08-20｜115 學年度方案分類修正

- 宜蘭縣成功國小、同樂國小、南屏國小及文化國中維持「策略聯盟」4 筆。
- 使用者列出的彰化縣、雲林縣及新北市學校共 68 筆標為「縣市合作」。
- 其餘未列入上述名單的 115 學年度紀錄共 64 筆標為「全國甄選」。
- 刪除臺南市紀安國小退出紀錄 1 筆；全部資料調整為 1,039 筆，115 學年度 136 筆。
- 重複資料鍵為 0；資料稽核與 Lint 通過。

## 2026-08-17｜修正宜蘭縣 115 學年度方案

- 宜蘭縣成功國小、同樂國小、南屏國小及文化國中 4 筆 115 學年度紀錄由「縣市合作」修正為「策略聯盟」。
- 全部資料維持 1,040 筆，115 學年度維持 137 筆；重複資料鍵為 0。
- 已同步更新可重複執行的 115 學年度補充匯入腳本。

## 2026-08-17｜修正 115 學年度縣市合作名單

- 刪除雲林縣三和國小 1 筆 115 學年度紀錄。
- 新增宜蘭縣成功國小（羅東鎮）、同樂國小（員山鄉）、南屏國小（宜蘭市）及文化國中（蘇澳鎮）共 4 筆。
- 《游於智》資料由 1,037 筆調整為 1,040 筆；115 學年度由 134 筆調整為 137 筆；不重複參與單位由 487 所調整為 486 所。
- 同屆同校重複鍵檢查為 0；資料稽核、Lint、TypeScript 與 GitHub Pages 建置通過。
